    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
           <button className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 hover:bg-slate-50 rounded-lg text-sm font-bold text-slate-600 transition-all">
              <Download className="w-4 h-4" />
              Download Source
           </button>
           <button className="flex items-center gap-2 px-4 py-2 bg-red-50 text-red-600 border border-red-100 hover:bg-red-100 rounded-lg text-sm font-bold transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
           ...
           <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm">
              <div className="flex items-start gap-6">
                 <div className="w-16 h-16 bg-[#009EE3] rounded-2xl flex items-center justify-center text-white shadow-lg">
                    <FileText className="w-8 h-8" />
                 </div>
                 <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                       <h2 className="text-2xl font-bold text-slate-900 tracking-tight">{doc.name}</h2>
                       <span className="px-2 py-0.5 bg-green-50 text-green-600 text-sm font-bold rounded border border-green-100 uppercase tracking-wider">
                          {doc.status}
                       </span>
                    </div>
              ...
              <div className="grid grid-cols-3 gap-8 mt-10 pt-8 border-t border-slate-50">
                 ...
                 <div>
                    <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">Indexed Fragments</p>
                    <p className="text-xl font-bold text-slate-900">{doc.indexedFragments.toLocaleString()}</p>
                 </div>
                 <div>
                    <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">Version Control</p>
           ...
           <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
              <div className="px-8 py-5 border-b border-slate-100 flex items-center justify-between">
                 ...
                 <button className="text-sm font-bold text-[#009EE3] uppercase hover:underline">Edit Fields</button>
              </div>
              <div className="grid grid-cols-2 gap-px bg-slate-100">
                 {doc.metadata.map((meta, i) => (
                    <div key={i} className="bg-white px-8 py-6">
                       <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-1">{meta.key}</p>
           ...
           <div className="bg-[#009EE3] text-white rounded-xl p-8 shadow-lg relative overflow-hidden">
        ...
        <div className="space-y-6">
           ...
           <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
              <h3 className="text-sm font-bold text-slate-900 uppercase tracking-widest mb-6">Document Identity</h3>
              <div className="space-y-5">
                 <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                       <Hash className="w-4 h-4 text-slate-300" />
                       <span className="text-sm font-bold text-slate-500 uppercase">System ID</span>
                    </div>
                    <span className="text-sm font-mono text-slate-900 font-bold bg-slate-50 px-2 py-1 rounded border border-slate-100">DOC-{doc.id.padStart(4, '0')}</span>
                 </div>
                 <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                       <Shield className="w-4 h-4 text-slate-300" />
                       <span className="text-sm font-bold text-slate-500 uppercase">Data Class</span>
                    </div>
                    <span className="text-sm font-bold text-slate-900 uppercase">{doc.type}</span>
                 </div>
                 <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                       <Clock className="w-4 h-4 text-slate-300" />
                       <span className="text-sm font-bold text-slate-500 uppercase">Last Sync</span>
                    </div>
                    <span className="text-sm font-bold text-slate-900 uppercase">{doc.lastAccessed}</span>
                 </div>
              </div>
           </div>
           ...
           {/* Event History */}
           <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
              <h3 className="text-sm font-bold text-slate-900 uppercase tracking-widest mb-6">Audit Trail</h3>
              <div className="space-y-6">
                    ...
                    <div key={i} className="flex gap-4 relative">
                       ...
                       <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                             <span className="text-sm font-bold text-slate-400 uppercase">{event.user}</span>
                             <span className="text-sm font-medium text-slate-300 uppercase">{event.time}</span>
                          </div>
                       </div>
                    </div>
                 ))}
           ...
           {/* Quick Actions Card */}
           <div className="bg-[#009EE3] rounded-xl p-6 text-white shadow-lg shadow-blue-300/50">
              ...
              <button className="w-full py-2.5 bg-white text-[#009EE3] rounded-lg text-sm font-bold hover:bg-slate-50 transition-all shadow-sm">
                 Upload New Version
              </button>
           </div>
        </div>
